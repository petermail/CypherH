...
namespace EncryptionSafe.Encryption
{
    ...
    {
        public static byte[] GetKeyInBytes(string passPhrase, byte[] saltValueBytes, int passwordIterations, int keySize)
        {
        ...
        public static byte[] GetKeyInBytes(byte[] passPhrase, byte[] saltValueBytes, int passwordIterations, int keySize)
        {
        ...
        public static string EncryptAes(string plainText, byte[] IV, byte[] key)
        {
            // Check arguments.
        ...
        public static string DecryptAes(string ciphertext, byte[] IV, byte[] key)
        {
